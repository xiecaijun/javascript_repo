...
BaronListIterator3.inst = new BaronListIterator3();

BaronListIterator3.getInstance=function(){
	return BaronListIterator3.inst;
}; 

BaronListIterator3.prototype.leftOrUp = function(){
	    var _inst = BaronListIterator3.inst;
...
BaronListIterator3.prototype.rightOrDown = function(){
...
/*初始化*/
BaronListIterator3.prototype.init = function(ul_id,width,derection,arrow)
{   
    BaronListIterator3.inst.ul_id = ul_id;
    BaronListIterator3.inst.width = width;
    BaronListIterator3.inst.arrow = arrow;    
    BaronListIterator3.inst.derection = derection;
     ...
     * @memberOf {TypeName} 
     */
    if(BaronListIterator3.inst.derection=="lr"){
    	//注册键控事件 
	    ...
	    baronkey.left.baronIterateList=BaronListIterator3.inst.leftOrUp; 
	    baronkey.right.baronIterateList= BaronListIterator3.inst.rightOrDown;	
    }else {
    	$("#"+ul_id +" a").attr("baronkeyCallback",function(i,oldv){
	    	if(oldv!=null&&oldv!=""&&typeof(oldv)!=undefined&&typeof(oldv)!="undefined"){
	    ...
	    baronkey.up.baronIterateList=BaronListIterator3.inst.leftOrUp; 
		baronkey.down.baronIterateList=BaronListIterator3.inst.rightOrDown;
	}  
 ...
 */
BaronListIterator3.prototype.iterate = function(){
    var _inst = BaronListIterator3.inst;
...
//    	rightId:"page_down"      //右导向箭头id或者下导向箭头id
//}
//BaronListIterator3.getInstance().init("zy_list",5,"lr",arrow);
